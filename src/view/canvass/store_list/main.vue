<template>
  <div>
    ...
    <Tabs :animated="false" style="margin-top: 5px;">
        <TabPane label="起租中">
          <tables ref="start_shops_tables"  v-model="start_shops_list" :columns="start_shops_columns" @data-view="showShopCard" @data-edit="editShopCard"/>
        ...
        <TabPane label="退租中">
          <tables ref="end_shops_tables"  v-model="end_shops_list" :columns="end_shops_columns" @data-view="showShopCard" @data-edit="editShopCard"/>
          <Page :total="end_shops_page.total" :page-size="end_shops_page.list_rows" style="margin-top:10px;" @on-change="getEndShopsNewPage"/>
        </TabPane>
        <TabPane label="已归档">
          <tables ref="eliminate_shops_tables"  v-model="eliminate_shops_list" :columns="eliminate_shops_columns" @data-view="showShopCard" @data-edit="editShopCard"/>
        ...
        <TabPane label="全部商户">
          <tables ref="all_shops_tables"  v-model="all_shops_list" :columns="all_shops_columns" @data-view="showShopCard" @data-edit="editShopCard"/>
